...
class PayvisionBasicOperationsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://testprocessor.payvisionservices.com/Gateway/BasicOperations.asmx?WSDL';
    /**
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'PayvisionBasicOperationsWsdlClass'))
            {
     ...
     * @uses PayvisionBasicOperationsWsdlClass::getSoapClientClassName()
     ...
     * If a class is named as {PayvisionBasicOperations}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('PayvisionBasicOperationsSoapClient') && is_subclass_of('PayvisionBasicOperationsSoapClient','SoapClient'))
            return 'PayvisionBasicOperationsSoapClient';
        else
            return 'SoapClient';
    }
    /**
     ...
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_EXCEPTIONS
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_FEATURES
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_LOGIN
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_PASSWORD
     ...
     * @uses PayvisionBasicOperationsWsdlClass::VALUE_WSDL_URL
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_USER_AGENT
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_PROXY_HOST
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_PROXY_PORT
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_PROXY_LOGIN
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_PROXY_PASSWORD
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_LOCAL_CERT
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_PASSPHRASE
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_AUTHENTICATION
     * @uses PayvisionBasicOperationsWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses PayvisionBasicOperationsWsdlClass::getSoapClient()
     * @uses PayvisionBasicOperationsWsdlClass::convertStringHeadersToArray()
