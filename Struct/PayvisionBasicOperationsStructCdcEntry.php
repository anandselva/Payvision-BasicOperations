...
class PayvisionBasicOperationsStructCdcEntry extends PayvisionBasicOperationsWsdlClass
{
    ...
    {
        parent::__construct(array('Name'=>$_name,'Items'=>($_items instanceof PayvisionBasicOperationsStructArrayOfCdcEntryItem)?$_items:new PayvisionBasicOperationsStructArrayOfCdcEntryItem($_items)),false);
    }
    /**
     * Get Name value
     * @return string|null
