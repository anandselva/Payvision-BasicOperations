...
class PayvisionBasicOperationsStructReferralApproval extends PayvisionBasicOperationsWsdlClass
{
    ...
    {
        parent::__construct(array('memberId'=>$_memberId,'transactionId'=>$_transactionId,'amount'=>$_amount,'currencyId'=>$_currencyId,'memberGuid'=>$_memberGuid,'transactionGuid'=>$_transactionGuid,'trackingMemberCode'=>$_trackingMemberCode,'approvalCode'=>$_approvalCode),false);
    }
    /**
     * Get memberId value
     * @return int
