...
class PayvisionBasicOperationsStructVoid extends PayvisionBasicOperationsWsdlClass
{
    ...
    {
        parent::__construct(array('memberId'=>$_memberId,'transactionId'=>$_transactionId,'memberGuid'=>$_memberGuid,'transactionGuid'=>$_transactionGuid,'trackingMemberCode'=>$_trackingMemberCode),false);
    }
    /**
     * Get memberId value
     * @return int
